...
> [!WARNING]
> **과거 실험 기록입니다.** 아래 10초·4피처 모델은 현재 배포 모델이 아닙니다. 현재 서비스는 `giukhaji/models/gait_daily_clinical_3feat.joblib`의 수직축 기반 3개 피처, 단일 신호 진폭 보정계수 `α = 1.9705`, 고정 임계값 `0.50`을 사용합니다.
