...
**평가 방식**: GroupKFold 5-fold OOF (group = subject_id, threshold = 0.470)

**Subject 단위 fold별 Train vs Test**

| Fold | Train AUC | Train Sen | Train Spec | Test AUC | Test Sen | Test Spec | Gap AUC | Gap Sen | Gap Spec |
|------|-----------|-----------|------------|----------|----------|-----------|---------|---------|----------|
| 1 | 0.885 | 0.793 | 0.704 | 0.889 | 1.000 | 0.778 | -0.004 | -0.207 | -0.074 |
| 2 | 0.896 | 0.808 | 0.774 | 0.756 | 0.889 | 0.600 | +0.140 | -0.081 | +0.174 |
| 3 | 0.867 | 0.857 | 0.724 | 0.959 | 1.000 | 0.714 | -0.092 | -0.143 | +0.010 |
| 4 | 0.914 | 0.897 | 0.750 | 0.813 | 0.500 | 0.750 | +0.101 | +0.397 | +0.000 |
| 5 | 0.872 | 0.893 | 0.759 | 0.959 | 0.857 | 0.714 | -0.087 | +0.036 | +0.044 |
| **평균** | **0.887** | **0.850** | **0.742** | **0.875** | **0.849** | **0.711** | **+0.012** | **+0.000** | **+0.031** |
...
| Subject (71명) — Train 평균 | 0.887 | 0.850 | 0.742 |
| Subject (71명) — Test OOF | 0.875 | 0.849 | 0.711 |
| **Train-Test Gap** | **+0.012** | **+0.000** | **+0.031** |

- Threshold 전략: Youden index (sens + spec 최대화) → 0.470
- VIF: 1.26~1.75 (다중공선성 없음)
- Gap AUC/Sen/Spec 모두 작음 → 과적합 없음
