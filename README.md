...
**평가 방식**: StratifiedGroupKFold 5-fold, 100회 반복 (group = subject_id, threshold = 0.470)

**100회 반복 CV 결과 (안정화 평균, n=100)**

| 지표 | Train | Test | Gap (Train − Test) |
|------|-------|------|---------------------|
| AUC | 0.888 ± 0.001 | 0.886 ± 0.015 | +0.001 ± 0.014 |
| Sensitivity | 0.852 ± 0.011 | 0.841 ± 0.023 | +0.011 ± 0.024 |
| Specificity | 0.736 ± 0.005 | 0.728 ± 0.028 | +0.009 ± 0.029 |

- Test Sen 범위: 0.798 ~ 0.912 (100회 평균 기준, 1.0 없음)
- Test Spec 범위: 0.633 ~ 0.791
...
| Subject (71명) — 100회 반복 Train 평균 | 0.888 ± 0.001 | 0.852 ± 0.011 | 0.736 ± 0.005 |
| Subject (71명) — 100회 반복 Test 평균 | 0.886 ± 0.015 | 0.841 ± 0.023 | 0.728 ± 0.028 |
| **Train-Test Gap** | **+0.001** | **+0.011** | **+0.009** |

- Threshold 전략: Youden index (sens + spec 최대화) → 0.470
- VIF: 1.26~1.75 (다중공선성 없음)
- Gap 모두 극소 → 과적합 없음
