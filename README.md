...
| 모델 | OOF AUC | Sen | Spec | Acc | Train AUC | Test AUC | Gap |
|------|--------:|----:|-----:|----:|----------:|---------:|----:|
| Voting | 0.891 | 0.825 | 0.806 | 0.817 | 0.996 | 0.892 | 0.104 |
| RF | 0.889 | 0.800 | 0.839 | 0.817 | 1.000 | 0.887 | 0.113 |
| **LR (최종 채택)** | **0.885** | **0.800** | **0.806** | **0.803** | **0.890** | **0.866** | **0.024** |
| Stacking | 0.873 | 0.875 | 0.806 | 0.845 | 0.999 | 0.883 | 0.116 |
| XGB | 0.871 | 0.875 | 0.806 | 0.845 | 0.998 | 0.876 | 0.122 |
| SVM | 0.869 | 0.800 | 0.742 | 0.775 | 0.895 | 0.865 | 0.029 |
| CNN1D | 0.857 | 0.800 | 0.774 | 0.789 | 1.000 | 0.877 | 0.123 |
| GBM | 0.829 | 0.800 | 0.677 | 0.746 | 1.000 | 0.850 | 0.150 |
| LSTM | 0.777 | 0.650 | 0.774 | 0.704 | 0.975 | 0.818 | 0.157 |

최고 AUC는 Voting/RF가 높지만 train-test gap이 0.10 이상으로 커서 71명 소표본에서 과적합 위험이 크다. LR은 AUC가 상위권이고 gap이 0.024로 가장 작으며, 모델 크기와 설명 가능성이 좋아 최종 서비스 모델로 유지한다.
